...
public interface CrudService<T, R, L> {
    T create(T entity);
    R read(Long id);
     ...
     */
    public PaginaResponse<L> findAll(List<String> filter, int page, int size, List<String> sort) throws FiltroException;
    /**
     ...
     * @throws FiltroException Si hay errores en los filtros o la ordenación (errorCodes: 'BAD_OPERATOR_FILTER','BAD_ATTRIBUTE_ORDER','BAD_ATTRIBUTE_FILTER','BAD_FILTER')
     */
    public PaginaResponse<L> findAll(PeticionListadoFiltrado peticionListadoFiltrado) throws FiltroException;
}
